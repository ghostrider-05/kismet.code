...
describe('Sequence item', () => {
    test('base item type guards', () => {
        ...
        expect(baseItem.isSequenceActionNode()).toEqual(false)
        ...
        expect(baseAction.isSequenceActionNode()).toEqual(true)
        ...
        expect(baseCondition.isSequenceActionNode()).toEqual(true)
        ...
        expect(baseEvent.isSequenceNode()).toEqual(true)
        expect(baseEvent.isSequenceActionNode()).toEqual(false)
        ...
        expect(baseSequence.isSequenceActionNode()).toEqual(false)
        ...
        expect(baseVariable.isSequenceActionNode()).toEqual(false)
