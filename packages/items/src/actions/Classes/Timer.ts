    ...
    constructor (options?: BaseKismetActionRequiredOptions) {
        super({
            ...
            inputs: {
                ...
                "output": [],
                "variable": [
                    "(ExpectedType=class'SeqVar_Float',LinkDesc=\"Time\",LinkVar=None,PropertyName=Time,bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=None,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0)"
                ]
            }
        })
    }
